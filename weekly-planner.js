(function(root,factory){
  ...
  function simulateActivityWeek(options={}){
    ...
    stageReports.forEach(stage=>{const scheduleText=scheduleSummary(schedule,stage.kind);stages.push({kind:stage.kind,label:stage.label,hours:round(stage.hours,2),team:stage.members,energy:Math.round(stage.energy),repeated:stage.repeated,lostTriggers:round(stage.lostTriggers,2),scheduleText})});
    const warnings=[];

(function(root,factory){
  ...
  function defaults(ingredients,now){
    return {schemaVersion:7,islandIndex:0,berries:[],recipeType:'咖喱／浓汤',preparationRecipeTypes:['咖喱／浓汤','沙拉'],activityKey:'normal',goodCamp:false,eventGoodCamp:true,travelTicketPlanned:true,basePot:LIMITS.permanentPot,mealGoal:15,targetRecipeId:'',currentSnorlaxStrength:0,sleepType:'balanced',sleepObjective:'combined',sleepTargetId:'',completedMeals:[],weekKey:weekKey(now),inventory:Object.fromEntries(ingredients.map(name=>[name,0]))};
  }

...
const scores = {
  candidate:{finalScore:78,speciesTier:'S',individualScore:78,finalFormId:'3',specialty:'ingredient'},
  old:{finalScore:62,speciesTier:'S',individualScore:62,finalFormId:'3',specialty:'ingredient'},
  roleBest:{finalScore:85,speciesTier:'S',individualScore:85,finalFormId:'9',specialty:'ingredient'},
  weak:{finalScore:20,speciesTier:'C',individualScore:20,finalFormId:'462',specialty:'ingredient'},
  oldC:{finalScore:62,speciesTier:'C',individualScore:62,finalFormId:'462',specialty:'ingredient'},
  same1:{finalScore:95,speciesTier:'S',individualScore:95,finalFormId:'26',finalFormNameZh:'雷丘',specialty:'berry'},
  same2:{finalScore:75,speciesTier:'S',individualScore:75,finalFormId:'26',finalFormNameZh:'雷丘',specialty:'berry'},
  same3:{finalScore:55,speciesTier:'S',individualScore:55,finalFormId:'26',finalFormNameZh:'雷丘',specialty:'berry'},
  same4:{finalScore:35,speciesTier:'S',individualScore:35,finalFormId:'26',finalFormNameZh:'雷丘',specialty:'berry'},
  same5:{finalScore:15,speciesTier:'S',individualScore:15,finalFormId:'26',finalFormNameZh:'雷丘',specialty:'berry'},
  suicune1:{finalScore:86,speciesTier:'A',individualScore:86,finalFormId:'245',finalFormNameZh:'水君',specialty:'skill'},
  suicune2:{finalScore:46,speciesTier:'A',individualScore:46,finalFormId:'245',finalFormNameZh:'水君',specialty:'skill'}
};
...
const release=retention.assessCandidate(weak,[{id:'c-old',recordId:'c-old',key:'oldC',shiny:'否'},roleBest],scoring);
...
const strategicScores=Object.fromEntries(['f1','f2','f3','f4','f5'].map((key,index)=>[key,{finalScore:90-index*8,speciesTier:'S',individualScore:90-index*8,finalFormId:'330',finalFormNameZh:'沙漠蜻蜓',specialty:'ingredient',strategy:flygonStrategy}]));

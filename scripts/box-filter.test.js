...
const pokemon=[
  {id:'1',pokedexId:25,name:'闪光食材手',boxId:'main',boxName:'实战主力',battleEligible:true,collectionIntent:true,shiny:'是',specialty:'ingredient',cultivation:{tier:'core',label:'核心培养'}},
  {id:'2',pokedexId:1,name:'普通食材手',boxId:'main',boxName:'实战主力',battleEligible:true,collectionIntent:false,shiny:'否',specialty:'ingredient',cultivation:{tier:'stage',label:'阶段培养'}},
  {id:'3',pokedexId:25,name:'闪光技能手',boxId:'shiny',boxName:'闪光收藏',battleEligible:false,collectionIntent:true,shiny:'是',specialty:'skill',cultivation:{tier:'avoid',label:'暂不建议'}},
  {id:'4',pokedexId:151,name:'普通技能手',boxId:'pending',boxName:'待整理',battleEligible:false,collectionIntent:false,shiny:'否',specialty:'skill',cultivation:{tier:'avoid',label:'暂不建议'}}
];

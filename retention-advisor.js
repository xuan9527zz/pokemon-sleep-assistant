(function(root,factory){
  ...
  function assessCandidate(candidate,box,scoring){
    ...
    return {verdict,tone,reason,score,sameSpecies,sameRole,speciesDelta,roleDelta,retentionLimit:limit,exceedsLimit,isLimitedSpecial:special,warnings:['这里只按同最终形态分配实战席位，不会把所有树果手／食材手混为一组；系统不会自动放生。闪光、独特食材路线、活动限定与已投入资源仍需人工复核。']};
  }

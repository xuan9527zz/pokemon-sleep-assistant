(function(root,factory){
  ...
  const SPECIES_ROLES=Object.freeze({
    ...
    '908':Object.freeze({name:'魔幻假面喵',stage:'forming',role:'窝心洋芋专职',ingredient:'窝心洋芋',rank:'primary',reason:'土豆岗位明确；岗位说明不改变用户维护的物种梯级。'}),
    '975':Object.freeze({name:'浩大鲸',stage:'forming',role:'窝心洋芋替代',ingredient:'窝心洋芋',rank:'alternative',reason:'土豆替代路线；是否严选仍以用户梯级与个体毕业状态判断。'}),
